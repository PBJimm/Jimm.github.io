	 ...
	 function drop(ev)
	    {
	        ...
	        document.getElementById('ecardcan').style.backgroundImage = "url('assets/images/informal_3.png')";
	        document.getElementById('ecardcan').style.backgroundSize = "400px 500px";
	        }
	        ...
	        else if(document.getElementById(data).id == 'img5'){             
	 	    document.getElementById('ecardcan').style.backgroundImage = "url('assets/images/formal_1.png')"; 
	 	    document.getElementById('ecardcan').style.backgroundSize = "400px 500px"; 
	        }
	        else if(document.getElementById(data).id == 'img6'){   
	        document.getElementById('ecardcan').style.backgroundImage = "url('assets/images/formal_2.png')";
	        document.getElementById('ecardcan').style.backgroundSize = "400px 500px";
	        }
	        else if(document.getElementById(data).id == 'img7'){   
	        document.getElementById('ecardcan').style.backgroundImage = "url('assets/images/formal_3.png')";
	        document.getElementById('ecardcan').style.backgroundSize = "400px 500px";
	        }
	        if(document.getElementById(data).id == 'img8'){             
	 	    document.getElementById('ecardcan').style.background = "url('assets/images/corporate_1.png')"; 
	 	    document.getElementById('ecardcan').style.backgroundSize = "400px 500px"; 
	        }
	        else if(document.getElementById(data).id == 'img9'){   
	        document.getElementById('ecardcan').style.backgroundImage = "url('assets/images/corporate_2.png')";
	        document.getElementById('ecardcan').style.backgroundSize = "400px 500px";
	        }
	        else if(document.getElementById(data).id == 'img10'){   
